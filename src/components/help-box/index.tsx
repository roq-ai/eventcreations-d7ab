...
export const HelpBox: React.FC = () => {
  ...
  const customerRoles: string[] = ['Event Attendee'];
  const tenantRoles: string[] = ['Event Organizer', 'Event Team Member', 'Event Sponsor', 'Event Vendor'];
  const addOns: string[] = ['chat', 'file', 'notifications'];
  const applicationName = `EventCreations`;
